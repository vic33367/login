...
namespace App1.iOS
{
    ...
    public partial class AppDelegate : global::Xamarin.Forms.Platform.iOS.FormsApplicationDelegate, ISQLAzure
    {
        ...
        public async Task<MobileServiceUser> Authenticate()
        {
            ...
            try
            {
                usuario = await App1.DataPage.cliente.LoginAsync(UIApplication.SharedApplication.KeyWindow.RootViewController, MobileServiceAuthenticationProvider.Google, "tesh2.azurewebsites.net");
                if (usuario != null)
                {
